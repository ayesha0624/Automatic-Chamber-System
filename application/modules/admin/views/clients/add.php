				...
				<?php echo form_open_multipart('admin/clients/add/'); ?>
                    <div class="box-body">
                        ...
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
                                    <label for="name" style="clear:both;"><?php echo lang('fathers_name')?></label>
									<input type="text" name="fathers_name" value="<?php echo set_value('fathers_name')?>" class="form-control">
                                </div>
                            </div>
                        </div>
